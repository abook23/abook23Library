...
public class HttpUtils {
    ...
    private static BasicCookieStoreHC4 cookieStore;
...
//            httpClient.getParams().setParameter(CoreConnectionPNames.SO_TIMEOUT, so_time_out); // 读取超时
    ...
    private void println(HttpInfo httpInfo) {
        if (DEBUG) {
            Log.d("HttpUtils", "httpCode:" + httpInfo.getHttpCode() + ";msg:" + HttpCodeType.getHttpMsg(httpInfo.getHttpCode()));
            Log.d("HttpUtils", httpInfo.getResult() + "");
        }
    }
