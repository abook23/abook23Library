 ...
 */
public class LinearLayoutMatchParent extends LinearLayout {
    ...
    public LinearLayoutMatchParent(Context context) {
        super(context);
        init(context);
    }

    public LinearLayoutMatchParent(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LinearLayoutMatchParent(Context context, AttributeSet attrs, int defStyleAttr) {
